...
| S01 | Spine walk-through part 1 (docs only): DISC_03 sections 1, 2 and 9 with one example row per table | S00 | Codex reviews (Alaa's standing authorisation of 10-Sep-2026 replaces a routine signature) | 1.5 / 2 | AUDIT 10-Sep-2026 (delivered; awaiting Codex review) |
